		...
		<div className='row mainHero'>
			<div className="col-sm heroHeadline2">
					...
					<div className="SignupForm2">
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2"></input>
							<label class="form-check-label" for="inlineCheckbox2">Keto</label>
						</div>
						<div className="2nddietcheckboxes">
						<div class="form-check form-check-inline">
								<input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1"></input>
								<label class="form-check-label" for="inlineCheckbox1">Paleo</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2"></input>
							<label class="form-check-label" for="inlineCheckbox2">Pescatarian</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2"></input>
							<label class="form-check-label" for="inlineCheckbox2">No restrictions</label>
						</div>
						<div className="BMItitle">
							<p className="BMIinfo">BODY MASS INDEX (BMI) IS A MEASURE OF BODY FAT BASED ON HEIGHT AND WEIGHT THAT APPLIES TO ADULT MEN AND WOMEN</p>
						</div>
						...
						<div className="BMIinfo">
							...
							<div className="BMIactivitybtn">
								<div class="3btnweight">
									<button class="btnactivity" type="button" id="activitybtn">Light</button>
									<button class="btnactivity" type="button" id="activitybtn">Moderate</button>
									<button class="btnactivity" type="button" id="activitybtn">Active</button>
								</div>
								<div>
